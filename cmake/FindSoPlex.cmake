...
# Search soplex.h
find_path(SOPLEX_INCLUDE_DIRS NAMES soplex.h HINTS ${_SOPLEX_ROOT_HINTS} PATHS ${_SOPLEX_ROOT_PATHS} PATH_SUFFIXES include src)
if (SOPLEX_INCLUDE_DIRS)
  
  # Extract version from spxdefines.h
  file(STRINGS "${SOPLEX_INCLUDE_DIRS}/spxdefines.h" _SOPLEX_VERSION_STR REGEX "^#define[\t ]+SOPLEX_VERSION[\t ]+[0-9][0-9][0-9].*")
  ...
  file(STRINGS "${SOPLEX_INCLUDE_DIRS}/spxdefines.h" _SOPLEX_SUBVERSION_STR REGEX "^#define[\t ]+SOPLEX_SUBVERSION[\t ]+[0-9].*")
  ...
  find_library(SOPLEX_LIBRARIES NAMES "soplex-${SOPLEX_VERSION_STRING}" PATHS ${_SOPLEX_ROOT_PATHS} PATH_SUFFIXES lib)

endif()

# Let cmake process everything.
include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(SoPlex REQUIRED_VARS SOPLEX_INCLUDE_DIRS SOPLEX_LIBRARIES VERSION_VAR SOPLEX_VERSION_STRING)
