...
#  set(SCIP_VERSION_STRING "${SCIP_VERSION_MAJOR}.${SCIP_VERSION_MINOR}.${SCIP_VERSION_PATCH}.${SCIP_VERSION_SUBVERSION}.${_SCIP_OSTYPE}.${_SCIP_ARCH}.${_SCIP_COMP}.${_SCIP_BUILD}")
  ...
  find_library(SCIP_SCIP_LIBRARY NAMES "scip-${SCIP_VERSION}.${_SCIP_VERSION_SUFFIX}"
    "scip-${SCIP_VERSION}.${SCIP_VERSION_SUBVERSION}.${_SCIP_VERSION_SUFFIX}" PATHS ${SCIP_ROOT_DIR} PATH_SUFFIXES ${_SCIP_LIB_PATHS}
    NO_DEFAULT_PATH NO_CMAKE_ENVIRONMENT_PATH NO_CMAKE_PATH NO_SYSTEM_ENVIRONMENT_PATH NO_CMAKE_SYSTEM_PATH NO_CMAKE_FIND_ROOT_PATH)
  find_library(SCIP_SCIP_LIBRARY NAMES "scip-${SCIP_VERSION}.${_SCIP_VERSION_SUFFIX}"
    "scip-${SCIP_VERSION}.${SCIP_VERSION_SUBVERSION}.${_SCIP_VERSION_SUFFIX}" PATHS ${SCIP_ROOT_DIR} PATH_SUFFIXES ${_SCIP_LIB_PATHS})
  ...
  if(${SCIP_VERSION_MAJOR} GREATER 3)
    ...
    find_library(SCIP_TPI_LIBRARY NAMES "tpi${SCIP_TPI}-${SCIP_VERSION_STRING}" PATHS ${SCIP_ROOT_DIR} PATH_SUFFIXES ${_SCIP_LIB_PATHS}
      NO_DEFAULT_PATH NO_CMAKE_ENVIRONMENT_PATH NO_CMAKE_PATH NO_SYSTEM_ENVIRONMENT_PATH NO_CMAKE_SYSTEM_PATH NO_CMAKE_FIND_ROOT_PATH)
  ...
  if(${SCIP_LPS} STREQUAL "spx")
    ...
    find_library(SCIP_LPI_LIBRARY NAMES "lpispx-${SCIP_VERSION_STRING}" "lpispx2-${SCIP_VERSION_STRING}" PATHS ${SCIP_ROOT_DIR} 
      PATH_SUFFIXES ${_SCIP_LIB_PATHS}
      NO_DEFAULT_PATH NO_CMAKE_ENVIRONMENT_PATH NO_CMAKE_PATH NO_SYSTEM_ENVIRONMENT_PATH NO_CMAKE_SYSTEM_PATH NO_CMAKE_FIND_ROOT_PATH)
    find_library(SCIP_LPI_LIBRARY NAMES "lpispx-${SCIP_VERSION_STRING}" "lpispx2-${SCIP_VERSION_STRING}" PATHS ${SCIP_ROOT_DIR}
      PATH_SUFFIXES ${_SCIP_LIB_PATHS})
